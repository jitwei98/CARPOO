		...
		<div class="w3-container page_container">
				...
				<table class="w3-table-all w3-hoverable">
					...
					$db = pg_connect($conn_str);
						...
						<tr>
							...
							<?php echo '<td><input type="text" name="plate_number"></td>'; ?>
						</tr>
						<tr>
							<td><label for="model"><b>Model : </b></label></td>
							<?php echo '<td><input type="text" name="model"></td>'; ?>
						</tr>
						<tr>
							<td><label for="color"><b>Color : </b></label></td>
							<?php echo '<td><input type="text" name="color"></td>'; ?>
						</tr>
				</table>
			...
			<h1>
				...
				if (!empty($_POST['create'])) {
					if (create_car($db)) { // affected rows > 0
						echo "Car successfully created!<br>";
					} else {
						echo "Error creating car!<br>";
